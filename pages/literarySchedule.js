...
const data = [
    {
      "ques": "Talk in a Tick (Just A Minute)",
    ...
    {
      "ques": "Positivity in Motion (How Positive You Can)",
    ...
    {
      "ques": "Clash of minds (Debate-(English and Hindi))",
    ...
    {
      "ques": "Tales on the Trail (Read A Thon)",
    ...
    {
      "ques": "Business Jugad (Business Proposal)",
    ...
    {
      "ques": "Lights, Camera, Advertisement! (AD MAD SHOW)",
    ...
    {
      "ques": "Isharo Isharo Mein (Dumb Charades)",
      "ans": "• Team size: 4 members.\n• One participant enacts the title of a movie, while the other guesses within 1 minute.\n• 4 rounds with scoring of 10 marks each.\n• Tie-breaker round in case of a tie."
    },
    {
